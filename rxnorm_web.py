#!/usr/bin/env python3
"""Local web UI for the RxNorm MVP inference script."""
...
def build_handler(config: AppConfig):
    class Handler(BaseHTTPRequestHandler):
        server_version = "RxNormMVPWeb/1.0"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run local web UI for RxNorm MVP.")
    parser.add_argument("--host", default="127.0.0.1", help="Host to bind.")
    parser.add_argument("--port", type=int, default=8000, help="Port to bind.")
    parser.add_argument(
        "--index-dir",
        default="artifacts/rxnorm_mvp",
        help="Index dir generated by rxnorm_mvp.py build-index.",
    )
    parser.add_argument(
        "--infer-script",
        default="rxnorm_mvp.py",
